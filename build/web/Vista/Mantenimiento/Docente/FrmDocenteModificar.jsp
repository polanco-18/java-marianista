...
<input type="hidden"  name="codigo" id="codigo" value="<%=objBean.getBDDATOPersona()%>">
...
<div class="card text-primary">
    <div class="card-header">
        <div class="row">
            <div class="col">
                <br>
                <br>
                <h4><b><i class="fas fa-edit"></i> Modificando Alumno : </b></h4>
            </div>
            <div class="col">
                <br>
                <br>
    ...
    <div class="card-body  text-primary">
        ...
        <div class="form-row">
            <div class="col">
                ...
                <select class="form-control" id="txt12" disabled>
    ...
    <div class="card-footer">
        <div class="form-row text-center ">
            <div class="col-md-2">
                <button type="button" class="btn btn-outline-warning" onclick="CambiodePagina('<%=request.getContextPath()%>', 'DocenteServlet', 0)" ><i class="fas fa-long-arrow-alt-left"></i> Regresar</button>
            </div>
            <div class="col-md-8">
            </div>
            <div class="col-md-2">
