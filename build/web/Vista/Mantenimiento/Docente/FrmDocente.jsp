        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="input-group">
                    <input type="search" id="txt1"class="form-control" placeholder="Buscar" onkeyup="BuscarR('<%=request.getContextPath()%>', 'DocenteServlet', 1)">      
                ...
                <table class="table table-hover" style="background-color: white">
                    ...
                    <tbody>             
                        ...
                        %>      <tr class="text-primary" >    
                            ...
                            <td><button class="btn btn-outline-primary" onclick="Modificar('<%=request.getContextPath()%>', 'DocenteServlet', 4, '<%=objeto.getBDDATOPersona()%>')"><i class="fas fa-info-circle"></i></button></td>
                        </tr>
                        <% }%>                              
                    </tbody>
                </table>
