...
<div class="card">
    <div class="card-header">
        <h3 class="text-primary"><b><i class="fas fa-plus-square"></i> Nueva Seccion</b></h3>
    </div>
        ...
        <div class="form-row">            
            ...
            <div class="form-group col"> 
                ...
                <select class="form-control text-primary" id="txt3">
                    <option>Salon - Edificio - Foro</option>
            ...
            <div class="form-group col"> 
                ...
                <select class="form-control text-primary" id="txt4">
                    <option>  Seleccione Tutor de Salon </option>
                    <%    for (DatoBean objeto : lista2) {%>
                    <option value="<%=objeto.getBDDATODocente()%>"><%=objeto.getBDDATO2()%> <%=objeto.getBDDATO3()%> <%=objeto.getBDDATO4()%></option> 
                    <% }%> 
                </select>
    ...
    <div class="card-footer">
        <div class="form-row text-center">
            ...
            <div class="col-md-2">                
                <button type="button" class="btn btn-outline-success" onclick="GrabarSalon('<%=request.getContextPath()%>', 'SeccionServlet', 3)"><i class="far fa-save"></i> Grabar</button>
            </div>
        </div>
    </div>
</div>